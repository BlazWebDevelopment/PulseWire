  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      <p className="text-slate-400 mb-8 max-w-md mx-auto">
        The page you&apos;re looking for isn&apos;t on the air. It may have
        been moved or retired from our archive.
      </p>
      <Link
        href="/"
        className="inline-block px-6 py-3 bg-gold-400 hover:bg-gold-300 text-ink-950 text-xs font-extrabold uppercase tracking-[0.22em] rounded-sm transition-colors"
      >
        Back to Homepage
      </Link>
    </div>
